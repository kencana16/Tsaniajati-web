...
<div class="row col-md-12">
  <div class="col-md-7">
    <h3 class="card-title p-2 rounded text-white" style="background-color:#8a8542;">
      <i class="fas fa-user mr-2"></i><b class="text-white">TSANIAJATI</b> | My Account
    </h3>
  </div>
  <div class="col-md-3">
  ...
  <div class="row col-md-12 mb-5">
    <div class="row col-md-3">
        <div class="list-group col-md-12 mt-3">
            ...
            <?php echo anchor('user_dashboard/daftar','<div class="list-group-item text-dark"><i class="fas fa-book mr-2"></i>Riwayat Pembelian</div>')?>
