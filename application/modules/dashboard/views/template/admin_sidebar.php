            ...
            <li class="nav-item mr-2">
                <form id="form_search" action="<?= site_url('dashboard/search');?>" method="post">
                    ...
                    <div class="input-group-append">
                        <button class="text-white" style="background:#8a8542;" type="submit" name="submit"><i class="fas fa-search"></i></button>
                    </div>
                    </div>
                </form>
            </li>
...
<aside class="main-sidebar sidebar-dark-primary elevation-4" style="position:fixed;">
    <!-- Brand Logo -->
    <a href="<?php echo base_url('beranda')?>" class="text-white brand-link" style="background:#8a8542;">
      <img src="<?php echo base_url('assets/dist/img/logoicak.png')?>"
           alt="KOPIKU" class="brand-image img-circle" >
      <span class="brand-text text-dark font-weight-bold">TSANIAJATI</span>
    </a>
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="<?php echo base_url('assets/dist/img/adm2.png')?>" class="img-circle elevation-2" alt="User Image">
            </div>
            <div class="info">
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview" style="background:#2b2f33;">
                        ...
                        <!-- </li> -->
                        <li class="nav-item" style="cursor:pointer;">
                            <a href="<?php echo base_url('preeorder')?>" class="nav-link">
                            <i class="fas fa-caret-right nav-icon"></i>
                            <p>Data Pree Order</p>
                            </a>
                        </li>
