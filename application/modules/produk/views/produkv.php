    ...
    <div class="row col-md-12 mt-3">
        ...
        <div class="col-md-3">
            <div class="dropdown text-dark">
                <a class="btn text-white btn-sm dropdown-toggle font-weight-bold float-right mr-2" style="background-color:#8a8542;" role="button" id="cart" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="cursor:pointer;">
            ...
            <div class="col-md-12">
                ...
                <div class="col-list-3 p-0" style="border-radius:15px">
                    <div id="myProduct" class="recent-car-list ml-3">
                        ...
                        <a href="<?= base_url('beranda/detail/'.$p['prod_id'])?>">
                            <div class="card m-0 shadow" style="border-radius:15px">
                                <div  class="card-header text-center m-0">
                                    <img src="<?= base_url()?>gambar/<?php echo $p['prod_img']; ?>" class="card-img-top rounded" alt="image" style="height: 250px;width: 100%;object-fit: cover;">
                                    <div class="middle">
                                        <?php
                                        if(!$p['quantity'] == 0 ){?>
                                ...
                                <div class="card-body p-0" style="margin-bottom:-10px;">
                                    <div class="col-md-12 bg-dark p-2">
                                        <h5 class="text-white font-weight-bold m-0" style="overflow:hidden;text-overflow:ellipsis;white-space:nowrap;"><?php echo $p['prod_name']; ?></h5>
                                    </div>
