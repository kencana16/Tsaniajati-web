...
class Produk extends CI_Controller {
	...
	public function index(){
		$data['judul'] = "TSANIAJATI | Daftar Produk";
	...
	public function produkbaru(){
		$data['judul'] = "TSANIAJATI | Produk Baru";
		$data['users']= $this->db->get_where('users', ['username' =>
		$this->session->userdata('username')])->row_array();
		$this->load->model('cart/M_Cart');
		$data['cart']= $this->M_Cart->get_data();
	...
	public function hargarendah(){
		$data['judul'] = "TSANIAJATI | Harga Terendah";
		$data['users']= $this->db->get_where('users', ['username' =>
		$this->session->userdata('username')])->row_array();
		$this->load->model('cart/M_Cart');
		$data['cart']= $this->M_Cart->get_data();
	...
	public function hargatinggi(){
		$data['judul'] = "TSANIAJATI | Harga Tertinggi";
		$data['users']= $this->db->get_where('users', ['username' =>
		$this->session->userdata('username')])->row_array();
		$this->load->model('cart/M_Cart');
		$data['cart']= $this->M_Cart->get_data();
	...
	public function daftar($id){
		$data['judul'] = "TSANIAJATI | Produk Kategori";
		$data['users']= $this->db->get_where('users', ['username' =>
		$this->session->userdata('username')])->row_array();
		$this->load->model('cart/M_Cart');
