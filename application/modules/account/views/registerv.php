    ...
    <div class="card-body register-card-body bg-light">
      ...
      <?php echo form_open('login/register');?>
        ...
        <div class="row justify-content-end">
          <div class="col-4">
            <input type="submit" class="btn text-white btn-block" style="background:#8a8542" name="btnSubmit" value="Daftar" />
            <?php echo form_close();?>
          </div>
        </div>
        <div class="row">
          <span>Saya sudah mempunyai akun, silahkan <a href="<?= base_url('login');?>" class="font-weight-bold text-green font-underline">Masuk</a></span>
        </div>
    </div>
    <!-- /.form-box -->
  </div><!-- /.card -->
