...
<head>
  ...
  <title><?= $judul ?></title>
  <link rel="shortcut icon" href="<?= base_url('assets/dist/img/logoicak.png')?>">
...
<!----------- NAVBAR ----------->
<div id="home"></div>
<div class="row mx-auto p-2" style="background:#8a8542" style="width:100%;">
  <div class="row col-md-2 mx-auto">
    <h5 class="text-white font-weight-light" style="font-size:13px;margin:auto;">✉ Tsaniafurniture@gmail.com</h5>
  </div>
	<div class="row col-md-3 mx-auto">
    <h5 class="text-white font-weight-light" style="font-size:13px;margin:auto;">☎ 0853-2647-7838</h5>
    <h5 class="text-white font-weight-light" style="font-size:13px;margin:auto;">◷ 07:00–19:00</h5>
  </div>
  ...
  <div class="row col-md ml-5">
    ...
    <a href="#" class="fa fa-whatsapp text-warning bg-dark text-center p-2 rounded mr-2" style="width:30px;"></a>
  </div>
</div>
<nav id="navbarku" class="navbar-expand-lg navbar navbar-light sticky-top bg-white shadow">
...
<!-----------NAV TITLE------->
  ...
  <a id="navbarku-title" class="navbar-brand font-weight-bold" href="#"><img alt="foto" src="<?= base_url('assets/dist/img/nav.png')?>"></a>
  <h1 id="nav-head" class="font-weight-bold text-dark mr-3" style="font-size:35px;" href="#">TSANIAJATI</h1>
<!-----------NAV TITLE------->
  <div class="collapse navbar-collapse" style="font-size:14px;" id="navbarSupportedContent">
      ...
      <form id="form_search" action="<?= site_url('beranda/search');?>" method="post">
        <div class="ml-5 input-group">
          ...
          <div class="input-group-append">
            <button class="btn" style="background-color:#8a8542;" type="submit" name="submit"><i class="text-white fas fa-search"></i></button>
          </div>
        </div>
      </form>
    ...
    <div class="navbar-nav ml-auto">
      <div class="dropdown">
        <a class="btn btn-dark btn-sm mr-2 dropdown-toggle text-white" role="button" id="cart" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="cursor:pointer;">
          ...
          <div class="dropdown-menu dropdown-menu-right p-0 mr-2" aria-labelledby="cart">
            <?php if (!$cart->result() ) { ?>
            <div class="row col-md-12 p-2 mx-auto card-body card-warning card-outline">
              <small class="font-italic text-danger">Keranjang belanja kosong!</small>
            </div>
            <?php }else{?>
              ...
              <div class="m-0 row col-md-12 card-footer p-1 bg-white">
                ...
                <div class="col-md-6 mx-auto">
                  <a href="<?= base_url('cart/transaction')?>"><div class="btn btn-sm btn-success btn-block"> Transaksi</div></a>
                </div>
              </div>
            <?php } ?>
          </div>
      ...
      ?>
        <div class="input-group-append" style="cursor:pointer;">
          <a class="btn btn-sm mr-3 text-white dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="background-color:#8a8542;"><?= $users['username'];?></a>
      ...
      <?php }else{ ?>
        <a href="<?= base_url('login')?>" class="btn btn-outline-dark btn-sm mr-3">Masuk</a>
      <?php } ?>
...
<div class="modal fade" id="logoutModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">Anda yakin keluar dari <b class="text-dark">TSANIAJATI</b> | My Account ?</div>
...
<div class="modal fade" id="nonaktif" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">Anda yakin untuk me-Nonaktifkan akun <b class="text-dark">TSANIAJATI</b> ?</div>
            <div class="modal-footer">
                <button class="btn btn-danger" type="button" data-dismiss="modal">Cancel</button>
