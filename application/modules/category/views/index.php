                ...
                <div class="container-fluid">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <button class="btn text-white btn-sm" style="background:#8a8542;" onclick="openPills('add-kat')"><i class="fas fa-plus"></i> Tambah Kategori</button>
                            </li>
                        </ol>
                    </div>
                    </div>
        ...
        <div id="add-kat" class="w3-container pills" style="display:none;"> 
            ...
            <section class="content-header">
                <div class="container-fluid">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item">
                            <button class="btn text-white btn-sm" style="background:#8a8542;" onclick="openPills('list-kat')"><i class="fas fa-undo"></i> Kembali</button>
                            </li>
                        </ol>
                    </div>
                    </div>
            ...
            <section class="content">
                ...
                <div class="card">
                    ...
                    <div class="card-footer text-right">Input Kategori Produk TSANIAJATI</div>
                </div>
            </section>
        </div>
    </div>
